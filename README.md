# monty
Monty 0.98 is a scripting language that is first compiled into Monty byte codes.It relies on a unique stack, with specific instructions to manipulate it. The goal of this project is to create an interpreter for Monty ByteCodes files. Monty was developed by the using an alternate point for making decisions as the Zen of Python by Tim Peters and aims at closing the gap between scripting and programming languages.
...
#### DOUGLAS KEN {https://github.com/dshikuta}
